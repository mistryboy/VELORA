...
export default function Collections() {
  ...
  return (
    <section id="vault" className="bg-vault-black py-32 px-20">
      <div className="max-w-7xl mx-auto">
        ...
        >
            <motion.div variants={headerChild} className="max-w-xl">
                ...
                <h3 className="font-heading text-6xl font-black text-vault-cream tracking-tighter uppercase leading-[0.8]">
                    The <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-[800px]">
          {collections.map((col, i) => (
            <motion.div
              ...
              className={`group relative overflow-hidden bg-vault-charcoal cursor-pointer ${
            ...
            >
              ...
              <div className="absolute inset-0 p-12 flex flex-col justify-end">
                <motion.span
                  ...
                  className="font-body text-[10px] tracking-[0.3em] uppercase text-vault-purple mb-2"
                >
                    {col.count}
                </motion.span>
                <h4 className="font-heading text-4xl font-black text-vault-cream uppercase tracking-tighter mb-6 group-hover:text-vault-purple transition-colors duration-300">
                    {col.title}
                </h4>
        ...
        >
            <button
              ...
              className="group relative px-14 py-7 border border-white/10 hover:border-vault-purple/50 transition-all duration-500 overflow-hidden cursor-pointer hover:shadow-[0_0_50px_rgba(168,85,247,0.15)] hover:scale-105 active:scale-95"
            >
                <span className="relative z-10 font-heading text-xs uppercase tracking-[0.5em] text-vault-cream transition-colors duration-500 group-hover:text-white flex items-center gap-4">
                    Explore The Archive
