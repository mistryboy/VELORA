...
export default function FeaturedDrops() {
  ...
  let drops = products.filter(p => p.newRelease).slice(0, 4);
  if (drops.length === 0) {
  ...
  return (
    <section id="drops" ref={targetRef} className="relative h-[300vh] bg-vault-charcoal">
      <div className="sticky top-0 h-screen flex items-center overflow-hidden">
        ...
        <div className="absolute top-1/2 left-20 -translate-y-1/2 opacity-[0.03] select-none pointer-events-none">
          <h2 className="font-heading text-[15rem] font-black uppercase text-white leading-none">
            LIMITED DROPS
          </h2>
        </div>
        ...
        <div className="flex flex-col w-full h-full justify-center pt-24">
            ...
            <motion.div
              ...
              className="px-20 mb-12 flex items-end justify-between relative z-10"
            >
                <div>
                   <span className="font-body text-[10px] tracking-[0.5em] uppercase text-vault-purple block mb-4">
                        Seasonal Exclusive
                   </span>
                   <h3 className="font-heading text-6xl font-black text-vault-cream tracking-tighter uppercase leading-none">
                        Featured <br />
                        <span className="text-transparent stroke-text">Releases</span>
                   </h3>
                </div>
                <div className="max-w-xs text-right">
                    <p className="font-body text-xs text-vault-cream/30 leading-relaxed uppercase tracking-widest">
            ...
            <motion.div style={{ x }} className="flex gap-12 px-20">
              {drops.map((drop, i) => (
                <motion.div 
                  ...
                  whileHover={{ y: -8 }}
                  className="group relative flex-shrink-0 w-[450px] aspect-[4/5] bg-vault-black/50 border border-white/5 overflow-hidden transition-all duration-700 hover:border-vault-purple/30 hover:shadow-[0_30px_80px_rgba(168,85,247,0.08)]"
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-10 flex flex-col justify-end">
                    <div className="overflow-hidden">
                        <span className="font-body text-[10px] tracking-[0.3em] uppercase text-vault-purple block mb-2 transform translate-y-full group-hover:translate-y-0 transition-transform duration-500 delay-100">
                            {drop.style}
                        </span>
                    </div>
                    <div className="overflow-hidden mb-4">
                        <h4 className="font-heading text-3xl font-black text-vault-cream uppercase tracking-tight transform translate-y-full group-hover:translate-y-0 transition-transform duration-500 delay-200">
                            {drop.name}
                        </h4>
                    </div>
              ...
              <motion.div
                ...
                className="group relative flex-shrink-0 w-[450px] aspect-[4/5] bg-vault-purple flex flex-col items-center justify-center gap-6 cursor-pointer overflow-hidden"
              >
                 ...
                 <h4 className="relative z-10 font-heading text-5xl font-black text-white uppercase tracking-tighter text-center group-hover:scale-105 transition-transform duration-700">
                    Explore <br /> All Drops
                 </h4>
                 <div className="relative z-10 w-12 h-12 rounded-full border border-white/30 flex items-center justify-center group-hover:bg-white group-hover:text-vault-purple group-hover:scale-110 group-hover:rotate-90 transition-all duration-500">
