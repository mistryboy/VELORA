    ...
    <section id="brand" ref={containerRef} className="relative h-[150vh] bg-vault-black overflow-hidden">
      <div className="sticky top-0 h-screen w-full flex items-center justify-center">
        ...
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center pointer-events-none">
            ...
            <motion.div style={{ opacity: text1_Opacity, y: text1_Y }} className="absolute text-center px-12">
                <span className="font-body text-[10px] tracking-[0.8em] uppercase text-vault-purple mb-4 block">Engineered for Velocity</span>
                <h3 className="font-heading text-7xl font-black text-vault-cream uppercase tracking-tighter">Carbon <span className="text-transparent stroke-text">Core</span></h3>
            </motion.div>

            <motion.div style={{ opacity: text2_Opacity, y: text2_Y }} className="absolute text-center px-12">
                <span className="font-body text-[10px] tracking-[0.8em] uppercase text-vault-red mb-4 block">Ultimate Comfort</span>
                <h3 className="font-heading text-7xl font-black text-vault-cream uppercase tracking-tighter">Cloud <span className="text-transparent stroke-text">Strike</span></h3>
            </motion.div>

            <motion.div style={{ opacity: text3_Opacity, y: text3_Y }} className="absolute text-center px-12">
                <span className="font-body text-[10px] tracking-[0.8em] uppercase text-vault-purple mb-4 block">Futuristic Control</span>
                <h3 className="font-heading text-7xl font-black text-vault-cream uppercase tracking-tighter">Liquid <span className="text-transparent stroke-text">Flow</span></h3>
            </motion.div>
        ...
        >
            <span className="font-body text-[8px] tracking-[1em] uppercase text-vault-cream/20">The SNEAKER VAULT Experience Prototype v.1.0</span>
        </motion.div>
      </div>
    </section>
  );
