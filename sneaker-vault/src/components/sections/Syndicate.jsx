...
export default function Syndicate() {
  ...
  return (
    <section ref={containerRef} className="relative py-40 bg-vault-charcoal overflow-hidden flex items-center min-h-[80vh]">
      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10 w-full">
        <div className="flex flex-col md:flex-row gap-16 md:gap-32">
            ...
            <div className="md:w-1/3">
                <span className="font-body text-[10px] tracking-[0.5em] uppercase text-vault-purple block mb-6">
                    Field Reports
                </span>
                <h3 className="font-heading text-5xl md:text-6xl font-black text-vault-cream tracking-tighter uppercase leading-none mb-6">
                    The<br />
            ...
            <div className="md:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
               {statements.map((item, i) => (
                  <motion.div 
                    ...
                    className="p-8 bg-vault-black/50 border border-white/5 hover:border-vault-purple/30 transition-all duration-500 group relative"
                  >
                     {/* Decorative Accent */}
                     ...
                     <p className="font-heading text-lg md:text-xl text-vault-cream/90 leading-snug tracking-wide uppercase mb-8">
                         &quot;{item.quote}&quot;
                     </p>
