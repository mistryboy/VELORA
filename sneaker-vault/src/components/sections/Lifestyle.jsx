...
export default function Lifestyle() {
  return (
    <section id="brand" className="bg-vault-charcoal py-32">
      <div className="max-w-[1600px] mx-auto px-16">
        ...
        >
            <motion.span variants={headerChild} className="font-body text-[10px] tracking-[0.5em] uppercase text-vault-purple block mb-4">
                Lifestyle & Vision
            </motion.span>
            <motion.h3 variants={headerChild} className="font-heading text-6xl font-black text-vault-cream tracking-tighter uppercase">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {images.map((img, i) => (
                ...
                >
                    ...
                    <div>
                        <h4 className="font-heading text-xl font-black text-vault-cream uppercase tracking-tight mb-2 group-hover:text-vault-purple transition-colors duration-500">
                            {img.title}
                        </h4>
                        <p className="font-body text-xs text-vault-cream/30 uppercase tracking-widest group-hover:text-vault-cream/50 transition-colors duration-500">
                            {img.desc}
                        </p>
                    </div>
                </motion.div>
        ...
        >
            <p className="font-heading text-2xl md:text-3xl font-light text-vault-cream/60 leading-relaxed">
