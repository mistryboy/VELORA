    ...
    >
      ...
      >
        ...
        <div className="p-10 lg:p-14 flex flex-col justify-center gap-6">
          <div>
            <span className="font-body text-[10px] tracking-[0.5em] uppercase text-vault-purple block mb-3">
              {product.style} · {product.category}
            </span>
            <h2 className="font-heading text-4xl lg:text-5xl font-black text-vault-cream uppercase tracking-tighter leading-[0.85]">
              {product.name}
            </h2>
          </div>

          <div className="flex items-center gap-4">
            <span className="font-heading text-3xl font-black text-vault-cream">${product.price}</span>
            {product.rating && (
            ...
            <div className="grid grid-cols-6 gap-2">
              {product.sizes.map((size) => (
                <button
                  ...
                  className={`py-2.5 text-[11px] font-heading font-bold border transition-all duration-300 ${
                    selectedSize === size
          ...
          <div>
            ...
            <div className="flex items-center gap-0 w-fit border border-white/10">
              <button onClick={() => setQuantity(Math.max(1, quantity - 1))} className="w-11 h-11 flex items-center justify-center text-vault-cream/60 hover:text-vault-cream hover:bg-white/5 transition-all duration-200">
                <Minus className="w-4 h-4" />
              </button>
              <span className="w-14 h-11 flex items-center justify-center font-heading text-sm font-bold text-vault-cream border-x border-white/10">{quantity}</span>
              <button onClick={() => setQuantity(quantity + 1)} className="w-11 h-11 flex items-center justify-center text-vault-cream/60 hover:text-vault-cream hover:bg-white/5 transition-all duration-200">
...
export default function StorePage() {
  ...
  return (
    ...
    >
        ...
        <div className="max-w-[1600px] mx-auto px-8 lg:px-16 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            >
              ...
              <span className="font-body text-[10px] uppercase tracking-widest hidden sm:inline">Back</span>
            </Link>
          ...
          <button
            ...
            className="relative group flex items-center gap-3 px-5 py-3 border border-white/10 hover:border-vault-purple/40 transition-all duration-300 hover:shadow-[0_0_25px_rgba(168,85,247,0.08)]"
          >
            <ShoppingBag className="w-4 h-4 text-vault-cream/60 group-hover:text-vault-purple transition-colors duration-300" />
            <span className="font-heading text-[10px] uppercase tracking-widest text-vault-cream/60 group-hover:text-vault-cream transition-colors duration-300 hidden sm:inline">Cart</span>
            {totalItems > 0 && (
              <motion.span
                key={totalItems}
                initial={{ scale: 0 }}
      ...
      <section className="relative overflow-hidden py-20 lg:py-28">
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-8 lg:px-16 text-center">
          <motion.span
            ...
            className="font-body text-[10px] tracking-[1em] uppercase text-vault-purple block mb-6"
          >
            The Archive
          </motion.span>
          <motion.h1
            ...
            className="font-heading text-5xl md:text-7xl lg:text-[6.5rem] font-black text-vault-cream uppercase tracking-tightest leading-[0.85] mb-6"
          >
      ...
      {/* ─── CATEGORY TABS ─────────────────────────────────────── */}
      <div className="max-w-[1600px] mx-auto px-8 lg:px-16 mb-8">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          {categories.map((cat) => (
            <button
              ...
              className={`px-6 py-3 font-heading text-[10px] uppercase tracking-widest transition-all duration-400 border ${
                activeCategory === cat
      ...
      {/* ─── FILTERS BAR ───────────────────────────────────────── */}
      <div className="max-w-[1600px] mx-auto px-8 lg:px-16 mb-12">
        <motion.div
      ...
      <footer className="border-t border-white/[0.04] py-12">
        <div className="max-w-[1600px] mx-auto px-8 lg:px-16 flex flex-col md:flex-row items-center justify-between gap-6">
